...
class Game {
    ...
    renderGameOver() {
        ...
        this.ctx.fillStyle = '#ffffff';
        this.ctx.font = '18px "Courier New", monospace';
        this.ctx.fillText('Artifacts collected: ' + this.artifactsCollected, this.width / 2, this.height / 2 + 20);
        this.ctx.fillText('Refresh the page to try again', this.width / 2, this.height / 2 + 60);
    }
